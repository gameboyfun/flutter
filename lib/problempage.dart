...
class Problempage extends StatefulWidget {
  ...
  Problempage(this.name, this.email, this.userid,this.reqoffice);

  @override
  _ProblempageState createState() => _ProblempageState(name, email, userid,reqoffice);
}
...
class _ProblempageState extends State<Problempage> {
  ...
  final String userid;
  String reqoffice;
  _ProblempageState(this.name, this.email, this.userid,this.reqoffice);
            ...
            child: SingleChildScrollView(
              child: Column(
                children: <Widget>[
                  ...
                  buildimagetb(context),
                  submitbuttb(context, name, email, subject, reqname, reqfor,
  ...
  Widget buildimagetb(BuildContext context) {
    return Container(
      width: 340,
      child: Column(
        children: <Widget>[
